...
public class CommentNotificationsRequest extends ActivityNotificationsRequest {
     ...
     * @param inStreamEntityId ID of the entity (person or group) who owns the
     * stream containing the activity.
     * @param inActivityId ID of the activity containing the comment.
     * @param inCommentId ID of the comment the event pertained to.
     */
