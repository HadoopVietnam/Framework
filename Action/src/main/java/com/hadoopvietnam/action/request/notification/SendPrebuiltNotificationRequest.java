...
/**
 * Request to send a pre-built notification. This request is received from
 * external sources and goes to the SendPrebuiltNotification action.
 */
public class SendPrebuiltNotificationRequest implements Serializable {
     ...
     * Constructor.
     *
     * @param inHighPriority If high priority.
     * @param inRecipientAccountId Person to receive notification.
     * @param inMessage The message.
     * @param inUrl Associated URL.
     */
    ...
    /**
     * @param inHighPriority the highPriority to set
     */
    ...
    /**
     * @param inRecipientAccountId the recipientAccountId to set
     */
