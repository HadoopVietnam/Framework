...
/**
 * Request to generate notifications when a group is removed (such as creation
 * denied). Any needed data must be captured in the request, since the group
 * will be deleted and thus cannot be looked up by the notifiers.
 */
public class GroupRemovedNotificationsRequest extends CreateNotificationsRequest {
     ...
     * @param inActorId Actor entity ID.
     * @param inGroupName Name of group.
     * @param inCoordinatorIds Group coordinators.
     */
