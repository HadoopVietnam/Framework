...
/**
 * Request to send a pre-built notification. This request is sent internally to
...
public class PrebuiltNotificationsRequest extends CreateNotificationsRequest {
     ...
     * @param inClientId ID of client (application, not person) who requested
     * the notification.
     * @param inRecipientId Person to receive notification.
