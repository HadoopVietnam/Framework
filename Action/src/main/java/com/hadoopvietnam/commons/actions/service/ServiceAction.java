...
/**
 * Service based implementation of the Action interface. Service actions are
 * intended to be called through the GWT RPC servlet and populated with an
 * appropriate ServiceActionContext.
 *
 */
public class ServiceAction implements Action {
     ...
     * {@link AuthorizationStrategy} for this action.
     * @param inExecutionStrategy - instance of the {@link ExecutionStrategy}
     * for this action.
