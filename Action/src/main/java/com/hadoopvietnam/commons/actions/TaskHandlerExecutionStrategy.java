 ...
 *
 * @param <T> - type of ActionContext that will be wrapped by the
 * TaskHandlerActionContext.
 */
public interface TaskHandlerExecutionStrategy<T extends ActionContext> {

    /**
     * Executes the business logic for the Action and assembles the
     * UserActionRequest objects that need to be submitted to the TaskHandler.
     *
     * @param inActionContext - instance of TaskHandlerActionContext that
     * contains the {@link ActionContext} for this execution strategy as well as
     * a List container for UserActionRequest objects assembled during
     * execution.
