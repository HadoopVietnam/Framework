...
/**
 * This is the context of the action. Each execution of an action has a unique
 * context described by this interface.
 *
 */
public interface ActionContext extends Serializable {
    ...
    /**
     * Retrieve the execution state of the Action. This is an instance
     * maintained by the controller to allow state to be passed between the
     * ValidationStrategy, AuthorizationStrategy and ExecutionStrategy
     * instances.
     *
