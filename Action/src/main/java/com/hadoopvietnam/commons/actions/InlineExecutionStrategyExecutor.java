 ...
 * execution strategies. Same fundamental purpose as
 * InlineExecutionStrategyWrappingExecutor but takes the action as a call
 * parameter instead of a constructor argument.
 */
public class InlineExecutionStrategyExecutor {
     ...
     *
     * @param execution The execution strategy.
     * @param params Parameters for the execution strategy to be invoked.
     * @param principal Principal to provide to the execution strategy.
     ...
     * @param execution The execution strategy.
     * @param params Parameters for the execution strategy to be invoked.
     * @param parentContext Caller's action context.
     * @return Return value from the execution strategy.
     */
     ...
     * @param params Parameters for the execution strategy to be invoked.
     * @param principal Principal to provide to the execution strategy.
     * @param requests List to receive any queued action requests from the
     * execution strategy.
     * @return Return value from the execution strategy.
     */
