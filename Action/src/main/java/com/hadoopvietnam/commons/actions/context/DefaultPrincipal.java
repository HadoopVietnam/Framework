...
/**
 * This class is a default implementation of the Principal interface. If
 * additional properties are needed, implement Principal in a concrete class
 * along with an associated {@link PrincipalPopulator} class.
 */
public class DefaultPrincipal implements Principal {
     ...
     *
     * @param inAccountId - string based account id to create the Principal
     * object with.
     * @param inOpenSocialId - string based opensocial id to create the
     * Principal object with.
