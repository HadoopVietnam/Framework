 ...
 */
package com.hadoopvietnam.commons.actions.context.service;
...
/**
 * ServiceAction implementation of the ActionContext this class implements
 * ActionContext, but also adds the Principal as well.
 *
 */
public class ServiceActionContext implements PrincipalActionContext {
     ...
     * Constructor.
     *
     * @param inParams - instance of the Params for the current action context.
     * @param inPrincipal - instance of the {@link Principal} for the current
     * action context.
     */
