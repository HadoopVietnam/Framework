 ...
 */
package com.hadoopvietnam.commons.actions.service;

import com.hadoopvietnam.commons.actions.AuthorizationStrategy;
...
import com.hadoopvietnam.commons.actions.ValidationStrategy;
import com.hadoopvietnam.commons.task.TaskHandler;

/**
 * This class represents the {@link ServiceAction} based implementation of the
 * {@link TaskHandlerAction} interface.
 *
 * TaskHandlerServiceActions are similar to ServiceActions but contain the
 * mechanisms to allow a TaskHandlerExecutionStrategy to build up
 * UserActionRequest objects and a configured {@link TaskHandler} for the
 * controller to use to submit the requests.
 *
 */
public class TaskHandlerServiceAction implements TaskHandlerAction {
     ...
     *
     * @param inValidationStrategy - instance of the {@link ValidationStrategy}
     * for this class.
     * @param inAuthorizationStrategy - instance of the
     * {@link AuthorizationStrategy} for this class.
     * @param inTaskHandlerExecutionStrategy - instance of the
     * {@link TaskHandlerExecutionStrategy} for this class.
     * @param inAsyncActionSubmitter - instance of the {@link TaskHandler} to
     * submit UserActionRequest objects to.
     * @param inReadOnly - flag indicating whether or not this action is read
     * only.
     */
