...
/**
 * The AuthorizationStrategy represents the logic that restricts execution
 * privileges of an action.
 *
...
public interface AuthorizationStrategy<T extends PrincipalActionContext> {
     ...
     *
     * @param inActionContext context of the Action being authorized.
