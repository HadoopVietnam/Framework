...
import com.hadoopvietnam.commons.actions.Action;
...
/**
 * Async based implementation of the Action interface. Async actions are
 * intended to be pulled off of the queue by the TaskQueueProcessor and
 * populated with an appropriate AsyncActionContext.
 *
 */
public class AsyncAction implements Action {
     ...
     * @param inExecutionStrategy - instance of the {@link ExecutionStrategy} to
     * use with this action.
     * @param inReadOnly - flag indicating whether this action need a readonly
     * transaction.
     */
