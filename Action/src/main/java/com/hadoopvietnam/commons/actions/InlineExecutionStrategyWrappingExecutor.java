...
/**
 * Class which allows execution strategies to easily be invoked inline by other
...
public class InlineExecutionStrategyWrappingExecutor {
     ...
     * Constructor.
     *
     * @param inNeedsPrincipal If the execution strategy needs a principal.
     * @param inPlainExecution Execution strategy to execute which does not need
     * to queue async tasks.
     */
     ...
     *
     * @param inNeedsPrincipal If the execution strategy needs a principal.
     * @param inTaskHandlerExecution Execution strategy to execute which does
     * need to queue async tasks.
     */
    public InlineExecutionStrategyWrappingExecutor(final boolean inNeedsPrincipal,
    ...
    /**
     * Invokes the execution strategy getting needed data from a provided
     * TaskHandlerActionContext.
     *
     * @param inActionContext Caller's TaskHandlerActionContext.
     * @param params Parameters for the execution strategy to be invoked.
     * @return Results from the invoked execution strategy.
     * @throws ExecutionException If execution strategy threw an exception or
     * call did not provide all data needed for the execution strategy.
     */
     ...
     * ActionContext.
     *
     * @param inActionContext Caller's ActionContext.
     * @param params Parameters for the execution strategy to be invoked.
     * @return Results from the invoked execution strategy.
     * @throws ExecutionException If execution strategy threw an exception or
     * call did not provide all data needed for the execution strategy.
