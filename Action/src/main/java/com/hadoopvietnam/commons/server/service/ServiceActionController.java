...
/**
 * This class provides the business logic that controls the execution of a
 * {@link ServiceAction}.
 *
 * Transaction management, and Validation, Authorization, and Execution strategy
 * sequences are also controlled in here.
 *
 ...
 * {@link ServiceAction} is controlled by this class and executed in the
 * following order:
 *
 ...
 * Optionally:
 *
 * submitAsyncRequests will be called in the case of a
 * {@link TaskHandlerAction}.
 *
 ...
 * client when encountered. - {@link AuthorizationException} will be logged and
 * passed to the client when encountered. - {@link ExecutionException} will be
 * logged and passed to the client when encountered.
 *
 */
public class ServiceActionController implements ActionController {
     ...
     */
    private final Logger logger = LoggerFactory.getLogger(ServiceActionController.class);
    /**
