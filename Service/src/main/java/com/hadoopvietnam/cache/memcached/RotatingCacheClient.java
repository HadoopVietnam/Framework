...
public class RotatingCacheClient implements Cache {
     ...
     * Constructor.
     *
     * @param inReadCacheRotator Cache rotator for read operations.
     * @param inWriteCacheRotator Cache rotator for write operations.
     */
     ...
     */
    @Override
    public void set(String inKey, int timeExpiration, Object inValue) {
        writeCacheRotator.getNext().set(inKey, timeExpiration, inValue);
    }
